...
//    self.gameLevelTensDigitalLabel.image = [TextureHelper timeTextures][0];
    ...
    self.gameTimeMinuteHunsDIgitalLabel.image = [self getNumberImage:self.gameTime/60/10/10];
    self.gameTimeMinuteTensDIgitalLabel.image = [self getNumberImage:self.gameTime/60/10%10];
